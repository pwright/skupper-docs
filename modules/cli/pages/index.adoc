...
+
--
include::example$ref.adoc[tags=init]
--
====
...
+
--
include::example$ref.adoc[tags=link]
--
====
...
+
--
include::example$ref.adoc[tags=expose]
--
====
...
+
--
include::example$ref.adoc[tags=servicecreate;servicebind]
--
====
